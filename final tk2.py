...
class Contenedores:
    ...
    def _crear_interfaz(self):
        if self.tipo == "listas":
            tk.Label(self.ventana, text="Lista de temperaturas", font=("Arial", 12, "bold")).pack(pady=5)
            self.lista = []
            ...
            tk.Label(self.ventana, text="Tupla de temperaturas", font=("Arial", 12, "bold")).pack(pady=5)
            self.tupla = ()
            self.entrada = tk.Entry(self.ventana, width=30)
            ...
            tk.Label(self.ventana, text="Curso 1", font=("Arial", 10)).pack()
            self.curso1 = set()
            self.curso2 = set()
            self.entrada1 = tk.Entry(self.ventana, width=30)
            self.entrada1.pack(pady=5)

            tk.Label(self.ventana, text="Curso 2", font=("Arial", 10)).pack()
            ...
            tk.Label(self.ventana, text="Registro de Empleados", font=("Arial", 12, "bold")).pack(pady=5)
            ...
            self.entrada_id.insert(0, "ID:")
            self.entrada_nombre.insert(0, "Nombre:")
            self.entrada_puesto.insert(0, "Puesto:")
            self.entrada_salario.insert(0, "Salario:")
            ...
            self.boton_actualizar = tk.Button(self.ventana, text="Actualizar salario", command=self.actualizar_salario)
            self.boton_eliminar = tk.Button(self.ventana, text="Eliminar", command=self.eliminar_empleado)
            self.boton_listar = tk.Button(self.ventana, text="Listar", command=self.listar_empleados)

            self.boton_agregar.pack(pady=3)
            self.boton_actualizar.pack(pady=3)
            self.boton_eliminar.pack(pady=3)
            self.boton_listar.pack(pady=3)
    ...
    def actualizar_salario(self):
        ...
        if id_emp in self.empleados:
            try:
                nuevo_salario = float(self.entrada_salario.get())
                self.empleados[id_emp]["salario"] = nuevo_salario
                messagebox.showinfo("Actualizado", f"Salario de {id_emp} actualizado.")
            except ValueError:
                messagebox.showerror("Error", "Salario inválido")
        else:
    ...
    def eliminar_empleado(self):
        ...
        if id_emp in self.empleados:
            ...
            messagebox.showinfo("Eliminado", f"Empleado {id_emp} eliminado.")
        else:
            messagebox.showerror("Error", "Empleado no encontrado")
